...
public class Automate : MonoBehaviour
{
    ...
    void Update()
    {
        if(moveList.Count>0 && !CubeState.autoRotating && CubeState.started) //&& not currently moving
        {
            //do move at first index
            DoMove(moveList[0]);
    ...
    public void Shuffle()
    {
        ...
        {
            int ranndomMove = Random.Range(0, allMoves.Count);
            moves.Add(allMoves[ranndomMove]);
        }
        moveList = moves;
    }
